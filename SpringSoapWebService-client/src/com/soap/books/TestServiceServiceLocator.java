...
public class TestServiceServiceLocator extends org.apache.axis.client.Service implements com.soap.books.TestServiceService {
    ...
    private java.lang.String TestService_address = "http://localhost:8080/SpringSoapWebService-server/services/TestService";
    ...
    public com.soap.books.TestService getTestService() throws javax.xml.rpc.ServiceException {
    ...
    public com.soap.books.TestService getTestService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.soap.books.TestServiceSoapBindingStub _stub = new com.soap.books.TestServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.soap.books.TestService.class.isAssignableFrom(serviceEndpointInterface)) {
                com.soap.books.TestServiceSoapBindingStub _stub = new com.soap.books.TestServiceSoapBindingStub(new java.net.URL(TestService_address), this);
                _stub.setPortName(getTestServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://books.soap.com", "TestServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://books.soap.com", "TestService"));
        }
